...
<th><?php echo $this->lang->line('last_qualification_in_subject'); ?></th>
            ...
            <td>
                <?php echo $teacher->last_qualification_in_subject; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."teachers/view_teacher/".$teacher->teacher_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."teachers/restore/".$teacher->teacher_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."teachers/delete/".$teacher->teacher_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
