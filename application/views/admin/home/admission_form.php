				...
				<table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <?php foreach($classes['session_courses'] as $session_course): ?>
							...
							<tr> 
                                ...
                                <?php if(strtolower($session_course->course_name)=='transport'){ ?>
                                        onclick="set_transport()" id="tranport_cb"
                                    <?php } ?>
                                
                                type="checkbox" name="session_course_id[]" value="<?php echo $session_course->session_course_id; ?>" /></td>
                                <td title="<?php 
                        ...
                        <?php endforeach; 
                              endforeach;
                        ?>
                        <tr><td colspan="4" style="text-align: center;"><input type="submit" name="admint_student" value="Admint Student" class="btn btn-danger" /></td></tr>
                            </tbody>
