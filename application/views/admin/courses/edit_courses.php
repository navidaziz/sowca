	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."courses/update_data/$courses->course_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("course_id", $courses->course_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("class", $courses->class),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("course_name", $courses->course_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("course_detail", $courses->course_detail),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("course_fee", $courses->course_fee),
					...
					$options = array("Yes" => "Yes", "No" => "No");
                        foreach($options as $option_value => $options_name){
                            ...
                            $data = array(
                                ...
                                "class"       => "uniform"
                                );if($option_value == $courses->is_subject){
                                    $data["checked"] = TRUE;
                                }
