...
<div class="row">
                            ...
                            ?>
                                ...
                                if ($courses_class->class == 0) { ?>
                                    <tr>
                                        <td colspan="7">
                                            <h5>
                                                <?php echo $courses_class->class; ?> </h5>
                                        </td>
                                    </tr>
                                <?php } else { ?>
                                    <tr>
                                    ...
                                    <form method="post" action="<?php echo site_url(ADMIN_DIR . "sessions/add_session_courses"); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="for m-control" min="1" required style="width: 70px;" type="number" value="" name="monthly_installment" />
                                            </td>
    ...
    <div class="col-md-6">
        <div class="box border blue" id="messenger">
            <div class="box-title">
                <h4><i class="fa fa-bell"></i> Session Courses </h4>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
