...
<th><?php echo $this->lang->line('end_date'); ?></th><th><?php echo $this->lang->line('Status'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
            ...
            <td>
                <?php echo $session->end_date; ?>
                                ...
                                <td>
                                    <?php echo status($session->status,  $this->lang); ?>
                                    <?php
                                        ...
                                        if($session->status == 0){
                                            echo "<a href='".site_url(ADMIN_DIR."sessions/publish/".$session->session_id."/".$page)."'> &nbsp;".$this->lang->line('Publish')."</a>";
                                        }
                                    ?>
                                </td>
                                <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."sessions/view_session/".$session->session_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."sessions/edit/".$session->session_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."sessions/trash/".$session->session_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
