	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."sessions/update_data/$session->session_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("session_id", $session->session_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("session_name", $session->session_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("session_detail", $session->session_detail),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $date = array(
                        ...
                        "value"         =>  set_value("start_date", $session->start_date),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $date = array(
                        ...
                        "value"         =>  set_value("end_date", $session->end_date),
