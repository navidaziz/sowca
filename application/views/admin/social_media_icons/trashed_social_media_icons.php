...
<th><?php echo $this->lang->line('social_media_link'); ?></th>
            ...
            <td>
                <?php echo $social_media_icon->social_media_link; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."social_media_icons/view_social_media_icon/".$social_media_icon->social_media_icon_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."social_media_icons/restore/".$social_media_icon->social_media_icon_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."social_media_icons/delete/".$social_media_icon->social_media_icon_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
