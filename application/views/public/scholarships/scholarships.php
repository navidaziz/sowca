...
<th><?php echo $this->lang->line('scholarship_value'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $scholarship->scholarship_value; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("scholarships/view_scholarship/".$scholarship->scholarship_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
