...
<th><?php echo $this->lang->line('end_date'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $session->end_date; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("sessions/view_session/".$session->session_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
