...
<th><?php echo $this->lang->line('is_subject'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $courses->is_subject; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("courses/view_courses/".$courses->course_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
