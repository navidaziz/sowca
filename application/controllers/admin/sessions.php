...
class Sessions extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Session');
        $this->data["view"] = ADMIN_DIR . "sessions/add_session";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($session_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Session');
        $this->data["view"] = ADMIN_DIR . "sessions/edit_session";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
